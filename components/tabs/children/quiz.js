...
export default class Quiz extends Component {
    ...
    const course = this.props.navigation.state.params.params;
    const quiz = params.params;
    const icon  = params.icon;
    const course_title = params.course_title;
    ...
    renderContent (quiz) {
        ...
        this.props.navigation.navigate('QuizTemplate',
            {
                params:quiz , icon : this.state.icon ,
